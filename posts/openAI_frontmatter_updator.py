#!/usr/bin/env python3
# LLM Based Frontmatter updator for Jekyll and MkDocs and Eleventy
# By Brian Khuu (2023)
...
def generate_response(content, existing_metadata, character_limit=2000):
    ...
    message_prompt=[
        ...
        {"role": "system", "content": "You are trying to generate metadata for a metadata frontmatter in eleventy"},
